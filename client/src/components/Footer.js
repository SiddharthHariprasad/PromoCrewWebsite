                ...
                <Row>
                    ...
                    <Col s={12} l={4} className="center">
                        ...
                        <Modal id="privacypolicy" header="Privacy Policy" trigger={<Button className="btn teal accent-4 black-text center-align modal-trigger">PRIVACY POLICY</Button>}>
                            <div className="modal-content">
                                <p>
                                    This website is operated by [God’s own tourism] and whose registered address is [God’s own tourism] we are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.
                                </p>
                            </div>
                        </Modal>
                    </Col>
